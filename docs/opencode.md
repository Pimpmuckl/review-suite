...
- prefers the final JSON text step containing Review Suite's terminal result marker and falls back to `opencode export <session>` if OpenCode finishes without emitting the final text event.
